...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raspy-sound-68ae)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-sound-68ae
```

A live public deployment of this template is available at [https://raspy-sound-68ae.templates.workers.dev](https://raspy-sound-68ae.templates.workers.dev)
